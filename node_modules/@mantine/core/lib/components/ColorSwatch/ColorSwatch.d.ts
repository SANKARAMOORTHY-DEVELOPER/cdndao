...
import { DefaultProps, MantineNumberSize, PolymorphicComponentProps, ClassNames } from '@mantine/styles';
import useStyles from './ColorSwatch.styles';
export declare type ColorSwatchStylesNames = ClassNames<typeof useStyles>;
