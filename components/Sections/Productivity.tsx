  ...
  return (
    <section aria-labelledby="productivity-title" className={styles.main}>
      ...
      <div>
        ...
        <p>
          Never let location be an issue when accessing your Algos. AlgoSphere has you
          covered for all of your Algorithms with our decentralized CDN solutions<br />
          <br />
          Discover AlgoSphere's Blockchain-Driven regulations, reshaping addictive algorithms for a healthier online experience
        </p>
        <Link href="#">
          <a>
            See how AlgoSphere works <Arrow />
          </a>
        </Link>
      </div>
    </section>
